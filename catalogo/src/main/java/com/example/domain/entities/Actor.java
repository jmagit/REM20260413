...
import com.example.core.contracts.domain.repositories.EntityWithId;
...
public class Actor extends AbstractEntity<Actor> implements Serializable, EntityWithId<Integer> {
    @Serial
...
//	@Pattern(regexp = "[A-Z]+", message = "Tiene que estar en mayusculas")
	...
	public List<FilmActor> getFilmActors() {
		return Collections.unmodifiableList(this.filmActors);
	}
	...
	protected void onChange(String property, Object old, Object current) {
		domainEvents.add(new DomainEvent(getClass().getSimpleName(), id, property, old, current));
	}
